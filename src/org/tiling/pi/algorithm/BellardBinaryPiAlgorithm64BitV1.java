...
/**
 * I am a version <a href="http://fabrice.bellard.free.fr/pi/">Fabrice Bellard</a>'s algorithm using longs rather than ints.
 */
public final class BellardBinaryPiAlgorithm64BitV1 implements FractionalPartCalculator {
	 ...
	 */	
	private final static long modPow(long n, long m) {
		long r = 1;
		long aa = b;
		while (true) {
			if ((n & 1) != 0)
